...
1.  Read the following statements carefully and then write the letter of the most correct answer.
    ...
    (vii) If it is 3:00 p.m. at Mwanza 33° E in Tanzania, what will be the time at Bangladesh 90° E?
...
2.  The following are matching items. Match the items in column A with the corresponding items in column B by writing its letter alongside column A as shown in the worked example (v).
    ...
    |                                                                         | F. Isobars                                                                |
    |                                                                         | G. Planting trees and burning grass                                       |
...
3.  The following statements are either TRUE or FALSE. In the space provided write TRUE if the statement is true and FALSE if the statement is false.
    ...
    (b) There is no direct relationship between the availability of raw materials and industrialization. .........
    (c) Seasons are more pronounced between 23½° and 66½° of latitude. .........
    ...
    (g) Rising and falling in the level of water in the oceans is called a current. .........
    (h) Good railway and road networks stimulate trade and commerce. .........
    (i) Bearing and distance is the only way of locating position on maps. .........
...
4.  (a) Study the diagram below and answer the questions that follow:
    ...
    | :----------- | :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
    | Temp. °C     | 25.5  | 25.8  | 26    | 26    | 27.3  | 26.5  | 26.5  | 26.1  | 26.8  | 26.8  | 26.3  | 25.7  |
    | Rainfall (mm) | 246   | 186   | 185   | 198   | 184   | 176   | 174.1 | 197   | 183   | 206   | 261   | 266   |
...
5.  (a) Explain five characteristics of sedentary livestock keeping.
    (b) Explain the features associated with rapid population growth.
    (c) Give suggestions on how to solve the problem of desertification.
    (d) Mention the problems associated with exploitation of forest resources.
    (e) Explain the main problems facing transport and communications in East Africa.
```