...
(ix) Which of the following is not a form of local government in Tanzania?
    A. Village Council
    B. Town Council
    C. National Assembly
    D. Municipal Council
...
2. Match the items in List B with those in List A. Write the letter of the item in List B against the number in List A.
...
(vii) Human rights include the right to education and freedom of worship.
